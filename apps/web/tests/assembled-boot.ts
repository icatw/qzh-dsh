...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-qzh-log-analysis', bundlePath: 'packages/client/ui-qzh-log-analysis/lib/client.js', url: '/plugins/ui-qzh-log-analysis.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-ui-conversation'] },
