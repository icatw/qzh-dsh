...
- **Evidence is re-sanitized** — the Host normalizes archive-relative paths, bounds metadata, and masks common authorization, cookie, token, password, secret, and private-key patterns before retaining the summary; per-file first-line layout samples are redacted and capped at 512 characters.
