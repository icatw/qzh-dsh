...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-qzh-log-analysis': { kind: 'none', reason: 'Browser-side QZH evidence workbench; registers no prompt, tool, message, or provider request.' },
  ...
  'packages/host/qzh-log-analysis': { kind: 'indirect', reason: 'Host-side QZH case service registers tools and guidance consumed by the DSH Agent Loop.' },
